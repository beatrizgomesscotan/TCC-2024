             ...
             <div style="font-family: Arial, sans-serif; text-align: center;">
               ...
               <table style="width: 100%; border-collapse: collapse; margin-top: 5px;">
                   ...
                   <tbody>
                       ${$scope.grid.map(item => `
                           <tr>
                               <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">${item.nomeCliente}</td>
                               <td style="border: 1px solid #ddd; padding: 8px; text-align: right;">${item.totalPedidos}</td>
                           </tr>
                       `).join('')}
                   </tbody>
               </table>
